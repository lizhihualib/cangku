...
$(function(){
	...
	$(pp).pagination({			
		...
		onSelectPage:function(curPage,pageSize){
			...
			$.ajax({
				url:"/junling/user/queryAuthors.action",
				type:"post",
				dataType:"json",
				data:data,
...
<table id="table"  class="easyui-datagrid"  url="/junling/user/queryAuthors.action" pagination="true"   method="post">
		<thead>
			<tr>
		...
		<form id="updateForm" method="post" style="width:100%;height:100%" buttons="#update-dlg-btns">
			...
			<table align="center">
				...
				<tr>
					...
					<td><input class="easyui-validatebox"  name="uEmail"  id="uEmail" validType="email" required="true"/></td>
				</tr>
				<tr>
					<td><label>著名：</label></td>
					<td><input class="easyui-textbox"  name="uPenName"  id="uPenName"  required="true"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input class="easyui-textbox"  name="uBankCard"  id="uBankCard" required="true"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input class="easyui-textbox"  name="uUploadNumbers"  id="uUploadNumbers"  required="true"/></td>
				</tr>
				<tr>
