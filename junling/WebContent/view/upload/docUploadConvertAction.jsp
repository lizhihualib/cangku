...
<%@page import="com.chinasoft.junling.controller.DocConverter"%>  
<%  
    //文件上传采用cos组件上传，可更换为commons-fileupload上传，文件上传后，保存在upload文件夹  
    //获取文件上传路径  
    String saveDirectory = application.getRealPath("/") + "view/upload";  
    //打印上传路径信息  
    ...
    while (files.hasMoreElements()) {  
        ...
        if (f != null) {  
            ...
            System.out.println("SWF路径："+d.getswfPath());  
            //生成swf相对路径，以便传递给flexpaper播放器  
          
            String swfpath = d.getswfPath().substring(d.getswfPath().lastIndexOf("/")+1);  
